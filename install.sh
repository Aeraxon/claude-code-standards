...
echo ""
echo "  3a. For NEW projects - Initialize:"
echo "      ${GREEN}/project-init${NC}"
echo ""
echo "  3b. For EXISTING projects - Adopt standards:"
echo "      ${GREEN}/project-adopt${NC}"
echo ""

echo "Available commands:"
echo "  ${BLUE}/project-init${NC}    - Initialize new project structure"
echo "  ${BLUE}/project-adopt${NC}   - Adopt existing project into standards"
